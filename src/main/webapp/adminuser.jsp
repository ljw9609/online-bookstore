    ...
    <div class="row-fluid">
        <div class="span3">
            <div class="sidebar-nav">
                ...
                <ul id="dashboard-menu" class="nav nav-list collapse in">
                    ...
                    <li class="active"><a href="<s:url action="adminuser"/>">Users</a></li>
        ...
        <div class="span9">
            ...
            <div class="btn-toolbar">
                <a href="adduser.jsp" role="button" class="btn"><i class="icon-plus"></i> New User</a>
                <div class="btn-group">
                </div>
            </div>
            <div class="well">
                <table class="table">
                    ...
                    <s:iterator value="#request.userlist">
                        <tr>
                            ...
                            <td>
                                <s:url action="edituser_show" var="editusershowlink">
                                    <s:param name="username"><s:property value="username" /></s:param>
                                </s:url>
                                <a href="${editusershowlink}" role="button"><i class="icon-pencil"></i></a>
                            </td>
                            <td>
                                <s:url action="deleteuser" var="deleteuserlink">
                                    <s:param name="userid"><s:property value="id"/></s:param>
                                </s:url>
                                <a href="${deleteuserlink}" role="button"><i class="icon-remove"></i></a>
                            </td>
                        </tr>
                    </s:iterator>
