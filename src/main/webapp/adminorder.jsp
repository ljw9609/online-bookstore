    ...
    <div class="row-fluid">
        ...
        <div class="span9">
            ...
            <div class="btn-toolbar">
                <a href="testajax.jsp" role="button" class="btn"><i class="icon-plus"></i> 查看统计</a>
                <div class="btn-group">
                </div>
            </div>
            <div class="well">
                <table class="table">
                    ...
                    <s:iterator value="#request.orderlist">
                        <tr>
                            ...
                            <td>
                                <s:url action="editorder_show" var="editordershowlink">
                                    <s:param name="orderid"><s:property value="id" /></s:param>
                                </s:url>
                                <a href="${editordershowlink}" role="button"><i class="icon-pencil"></i></a>
                            </td>
                            <td>
                                <s:url action="deleteorder" var="deleteorderlink">
                                    <s:param name="orderid"><s:property value="id"/></s:param>
                                </s:url>
                                <a href="${deleteorderlink}" role="button"><i class="icon-remove"></i></a>
                            </td>
                        </tr>
                    </s:iterator>
